...
**Step 1:** Create your private repository using the following link:
...
You may need to wait a minute for the website to deploy.  After that, make sure to test everything by pointing your web browser at the link generated for your build:
