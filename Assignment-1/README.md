...
**Step 1:** Create your private repository using the following link: https://classroom.github.com/a/obmbE1xo
...
- When the user clicks the mouse, a new instance of the laser object should be added to the scene. (2)
  ...
  *Added 1/31/2024. The comments in the code reference the ShapeInstance class, which was deprecated in GopherGfx. For this part, you can just create a new Mesh2 object for each laser. Alternatively, you could create a single Mesh2 object to use as a template, and then create multiple instances (copies) by calling the createInstance() method.*
